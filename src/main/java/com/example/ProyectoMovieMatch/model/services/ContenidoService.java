...
import com.example.ProyectoMovieMatch.model.repositories.RatingRepository;
import com.example.ProyectoMovieMatch.model.repositories.SerieRepository;
...
public class ContenidoService {
    ...
    public List<PeliculaEntity> datosPeliculaBDD()
    {
        traerPeliculaAPI();
        return peliculaRepository.findAll();
    }

    public List<SerieEntity> datosSerieBDD()
    {
        traerSeriesAPI();
    ...
    public List<ContenidoEntity> datosBDD()
    {
        traerPeliculaAPI();
        traerSeriesAPI();
